...
namespace Day3MVC.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StateId,Name,Abbreviation")] States states)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StateId,Name,Abbreviation")] States states)
        {
            if (ModelState.IsValid)
            {
